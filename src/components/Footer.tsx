            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-12 gap-8 mb-10">
                    <div className="md:col-span-4 lg:col-span-4">
                        <Link href="/" className="mb-6 inline-block bg-white py-2 px-4 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                ...
                <div className="pt-6 border-t border-slate-800 flex flex-col xl:flex-row justify-between items-center gap-6 text-sm relative">
                    ...
                    <div className="flex gap-2">
                        {/* LinkedIn */}
                        <Link href="https://linkedin.com/company/zettab" target="_blank" rel="noopener noreferrer" className="size-9 bg-slate-800 rounded-lg flex items-center justify-center text-white hover:bg-[#0A66C2] transition-colors">
