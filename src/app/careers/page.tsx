            ...
            <section className="py-24 bg-slate-50 border-t border-slate-200">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="p-12 md:p-16 bg-white rounded-3xl border border-slate-200 text-center shadow-sm cta-banner-card">
                        <h2 className="font-bold text-4xl text-slate-900 mb-4">Interested in future opportunities?</h2>
                        <p className="text-xl text-slate-600 mb-10 max-w-2xl mx-auto">Even if there is no perfect role today, we are always happy to connect with talented engineers, designers, and strategists.</p>
                        <Link href="mailto:careers@zettab.io" className="cta-banner-button inline-flex items-center justify-center gap-2 px-10 py-5 bg-white text-slate-900 border border-slate-200 rounded-xl font-bold text-lg">
                            Contact Recruiting <span className="material-symbols-outlined text-sm">forum</span>
                        </Link>
                    </div>
                </div>
            </section>
