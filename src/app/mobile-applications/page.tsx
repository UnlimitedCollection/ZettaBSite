        ...
        <main>
            ...
            <section className="relative pt-28 pb-20 sm:pt-32 sm:pb-24 text-center overflow-hidden min-h-[62vh] flex items-center">
                ...
                <div className="absolute inset-0 z-0 bg-slate-900">
                    <img src="/service_bg_mobile_new.svg" alt="Mobile Applications Background" className="service-hero-image w-full h-full object-cover object-center opacity-100" />
            ...
            <section className="py-24 bg-white">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="p-12 md:p-16 bg-slate-50 rounded-3xl border border-slate-200 text-center shadow-sm cta-banner-card">
                        <h2 className="font-bold text-4xl text-slate-900 mb-4">Planning a mobile app launch?</h2>
                        <p className="text-xl text-slate-600 mb-10 max-w-2xl mx-auto">Speak with our app team to choose the right platform strategy, feature scope, and release plan for your product.</p>
